...
build:
  render: false
  list: true
description: "Jane Eyre Chapter 17 — ."
---
...
frocks; to furbish up any that were "_passees_," and to air and arrange
...
company,--to conduct the ladies to their rooms, &c. Adèle, too, would be
...
removed; Adèle and I sat down on the top step of the stairs to listen.
...
daughters, the eldest, Amy, was rather little: naïve, and child-like in
...
_minois chiffone_: both sisters were fair as lilies.
...
a "père noble de theâtre." Lord Ingram, like his sisters, is very tall;
